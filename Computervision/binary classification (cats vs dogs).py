...
Original file is located at
    https://colab.research.google.com/drive/1V5c-vqR7oQa1TczlBoa60Jakz3tMR341
...
def split_data(SOURCE_DIR, TRAINING_DIR, VALIDATION_DIR, SPLIT_SIZE):
  ...
  valid_files = [f for f in files if os.path.getsize(os.path.join(SOURCE_DIR, f)) > 0]
    ...
    # If there are any files with zero length, print out a message
  for f in files:
...
def train_val_generators(TRAINING_DIR, VALIDATION_DIR):
  ...
  ### START CODE HERE
    ...
    # Use rescale to normalize pixel values from [0, 255] to [0, 1]
...
def create_model():
  ...
  model = tf.keras.models.Sequential([
    ...
    # Calculate the output size of the Flatten layer and adjust the Dense layer accordingly
    tf.keras.layers.Dense(128, activation='relu'),  # Reduced number of neurons
